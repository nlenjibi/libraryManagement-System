                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id="tables">
                            ...
                            <tbody>
                                <?php
                                // Get pending book requests (assuming we'll use a request table or status-based system)
                                // For now, let's create some sample pending requests or show issued books
                                $sql = "SELECT r.BookId, r.RollNo, b.Title, b.Availability, r.IssueDate 
                                   FROM record r 
                                ...
                                if (empty($results)) {
                                    ...
                                    echo "<em>No pending book issue requests at this time.</em>";
                                    echo "</td></tr>";
                                } else {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    ?>
                                                    <a href="reject.php?id1=<?php echo $bookid ?>&id2=<?php echo $rollno ?>"
