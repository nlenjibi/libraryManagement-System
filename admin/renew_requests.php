                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id="tables">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT r.BookId, r.RollNo, b.Title, r.Status, r.IssueDate, r.ReturnDate 
                                   FROM renew r 
                                ...
                                if (empty($results)) {
                                    ...
                                    echo "<em>No pending renewal requests at this time.</em>";
                                    echo "</td></tr>";
                                } else {
                                    foreach ($results as $row) {
                                        ...
                                        $rollno = $row['RollNo'];
                                        $name = $row['Title'];
                                        $renewals = 2; // Default renewals left
