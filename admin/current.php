                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        if (isset($_POST['submit'])) {
                            $s = $_POST['title'];
                            $sql = "SELECT r.BookId, r.RollNo, b.Title, r.IssueDate, r.ReturnDate, 
                                   DATEDIFF(CURDATE(), r.ReturnDate) as days_overdue 
                                   FROM record r 
                                   JOIN book b ON b.BookId = r.BookId 
                                   WHERE r.Status = 'Issued' 
                                   AND (r.RollNo = ? OR r.BookId = ? OR b.Title LIKE ?)";
                        ...
                        if (!$rowcount)
                            echo "<br><center><h2><b><i>No books are currently issued</i></b></h2></center>";
                        else {
                            ...
                            <table class="table" id="tables">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $row) {
                                        ...
                                        $duedate = $row['ReturnDate'];
                                        $dues = $row['days_overdue'];
